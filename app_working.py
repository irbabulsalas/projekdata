...
st.set_page_config(
    page_title="🚀 ProjekData - Working Version",
    page_icon="📊",
    layout="wide",
...
if page == "🏠 Home":
    ...
    st.markdown('<p style="text-align: center; font-size: 1.2rem; color: #666;">AI Data Analysis Platform - Working Version</p>', unsafe_allow_html=True)
...
# About page
    ...
    **Description:**
    ...
    - **Documentation**: Check out the project files
    - **Quick Start**: See the setup instructions
    - **Troubleshooting**: Check the error messages
...
st.markdown(
    ...
    "🚀 ProjekData - AI Data Analysis Platform | Working Demo Version"
    "</div>",
    unsafe_allow_html=True
)